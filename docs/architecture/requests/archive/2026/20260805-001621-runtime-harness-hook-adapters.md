...
> **Status**: Resolved
> **Detected**: 2026-08-05T00:14:15+0800
> **Updated**: 2026-08-05T00:14:15+0800
> **Severity**: high
> **Change Type**: workflow-surface
> **File**: `src/cli/hook/mutation-guard.ts`
...
| --- | --- | --- | --- |
| 2026-08-05T00:14:15+0800 | high | workflow-surface | `src/cli/hook/mutation-guard.ts` |

## Event Fields

```json
{
  "ts": "2026-08-05T00:14:15+0800",
  "file_path": "src/cli/hook/mutation-guard.ts",
  "severity": "high",
...
- Status: Resolved
- Archived: 2026-08-05T00:16:22+0800
- Artifacts:
- `docs/architecture/modules/runtime-harness/hook-adapters.md`
- Note: Documented the contract-scoped checks_failed repair boundary and preserved stop/ship plus out-of-scope fail-closed behavior.
