# Task Contract: root-cause-fixture-artifact-missing
...
a bugfix contract whose pre_fix_failure_artifact path does not exist is rejected by the
gate.

## Goal

Exercise the root-cause gate's pre_fix_failure_artifact existence check.
...
- pre_fix_failure_artifact: tests/fixtures/root-cause/does-not-exist.log
