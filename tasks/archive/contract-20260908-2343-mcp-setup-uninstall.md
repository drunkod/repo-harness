...
# Task Contract: mcp-setup-uninstall
...
MCP setup leaves active registration and credential configuration; cleanup must preserve shared user authority.

## Goal

Deliver offline scoped MCP uninstall with precise configuration and registry restoration, dry-run and preserved static data.

## Scope

- In scope: MCP setup/uninstall, owned registry restoration, tests and docs.
- Out of scope: live services, remote connectors, package release, workspace deletion.
...
A fixture losing unrelated shared configuration or authorization falsifies the design.
...
- Source plan: `plans/archive/plan-20260908-2325-mcp-setup-uninstall.md`
...
allowed_paths:
  ...
  - plans/
  - tasks/todos.md
  - tasks/archive/contract-20260908-2343-mcp-setup-uninstall.md
  - tasks/archive/review-20260908-2343-mcp-setup-uninstall.md
  - tasks/archive/notes-20260908-2343-mcp-setup-uninstall.md
  - src/cli/
